...
const { visibleUpdateRubricModal } = useRubricStore
...
export default () => {
    ...
    const [changedText, setText] = useState(currentUpdateRubric.value)
    const [changedSeoTitle, setSeoTitle] = useState('')
    const [changedSeoDescription, setSeoDescription] = useState('')
    // const seoTitle = changedSeoTitle || currentSeoTitleRubric;
    // const seoDescription = changedSeoDescription || currentSeoDescriptionRubric;

    const [selectedParent, setSelectedParent] = useState(
        currentUpdateRubric?.parent?.id,
    )
    ...
    let formData = {
        id: currentUpdateRubric.id,
        selectedParent,
        text: changedText || currentUpdateRubric.value,
        slug: changedText
            ? slugify(changedText.translit())
            : currentUpdateRubric.slug,
        idTitle: currentUpdateRubric.seoTitle?.id,
    ...
    //                 updateSeoTitle: {
    //                     key: '1',
    //                     id: currentIdSeoTitleRubric,
    //                     value: seoTitle,
    //                 },
    //                 updateSeoDescription: {
    //                     key: '1',
    //                     id: currentIdSeoDescriptionRubric,
    ...
    return (
        <>
            <Transition.Root
                show={currentVisibleUpdateRubricModal}
                as={Fragment}
            >
                <Dialog
                    as="div"
                    ...
                    onClose={() => closeVisibleUpdateRubricModal()}
                >
                    <Transition.Child
                        as={Fragment}
